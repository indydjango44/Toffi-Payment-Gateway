...
class WC_Toffi_Source_Gateway extends WC_Payment_Gateway
{
	...
	protected function setup_properties() {
		...
		$this->method_description = 'Toffi Source Gateway for handling redirected payments';
		$this->enabled = 'yes';
	...
	public function init_form_fields()
	{
		...
		$this->form_fields = array(
			...
			'title' => array(
				...
				'default' => _x('+5% fees Credit Cards through PayPal / Stripe', '+5% fees Credit Cards through PayPal / Stripe', 'toffi-source'),
				'desc_tip' => true,
			),
			'description' => array(
			...
			//proxy-settings        
			'enableproxy' => array(
				'title' => __('Enable/Disable Proxy', 'toffi-source'),
				'label' => 'Enable Proxy for API calls from Source website (socks4/socks5)',
				'type' => 'checkbox',
				'description' => '',
				'default' => 'no'
			),
